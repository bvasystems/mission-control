...
const rowSchema = z.object({
  ...
  reliability_meta: z.record(z.string(), z.any()).optional(),
});
...
for (const r of parsed.data.rows) {
  ...
  await client.query(
    ...
    (id, date, messages_sent, skills_used, errors, model_tokens_used, uptime_hours, agent_id, reliability_score, reliability_meta)
    values
    (gen_random_uuid(), $1::date, $2, $3, $4, $5, $6, $7, $8, $9)
    ...
    reliability_meta = excluded.reliability_meta
    `,
    [
      r.date,
      r.messages_sent,
      ...
      r.reliability_meta ? JSON.stringify(r.reliability_meta) : null,
    ]
  );
}
